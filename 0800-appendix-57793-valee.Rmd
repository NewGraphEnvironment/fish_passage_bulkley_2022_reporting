...
At the time of the survey, PSCIS crossing `r as.character(my_site)` was un-embedded, non-backwatered and ranked as a `r fpr::fpr_my_pscis_info(col_pull = barrier_result) %>% stringr::str_to_lower()` barrier to upstream fish passage according to the provincial protocol [@moe2011Fieldassessment] (Table \@ref(tab:tab-culvert-57793)). Water temperature was `r fpr::fpr_my_habitat_info(col_pull = 'temperature_c')`$^\circ$C, pH was `r fpr::fpr_my_habitat_info(col_pull = 'p_h')` and conductivity was `r fpr::fpr_my_habitat_info(col_pull = 'conductivity_m_s_cm')`uS/cm. 
...
The stream was also surveyed at a second location upstream of the hatchery adjacent to the Owen Road bridge for `r fpr::fpr_my_priority_info(loc = 'us2', col_pull = 'length_surveyed')`m `r if(gitbook_on){knitr::asis_output("(Figures \\@ref(fig:photo-57793-05) - \\@ref(fig:photo-57793-06))")}else(knitr::asis_output("(Figure \\@ref(fig:photo-57793-d03))"))`. `r fpr::fpr_my_cover_sentence(loc = 'us2')` The average channel width was `r fpr::fpr_my_habitat_info(loc = 'us2', col_pull = 'avg_channel_width_m')`m, the average wetted width was `r fpr::fpr_my_habitat_info(loc = 'us2', col_pull = 'avg_wetted_width_m')`m and the average gradient was `r fpr::fpr_my_habitat_info(loc = 'us2', col_pull = 'average_gradient_percent')`%. The dominant substrate was `r fpr::fpr_my_habitat_info(loc = 'us2', col_pull = "bed_material_dominant")` with `r fpr::fpr_my_habitat_info(loc = 'us2', col_pull = "bed_material_subdominant")` subdominant.  The habitat was rated as `r fpr::fpr_my_priority_info(loc = 'us2')` value for salmon rearing and spawning. 
