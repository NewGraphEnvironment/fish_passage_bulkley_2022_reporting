...
At the time of the survey, PSCIS crossing `r as.character(my_site)` was non-backwatered and ranked as a `r fpr::fpr_my_pscis_info(col_pull = barrier_result)` to upstream fish passage according to the provincial protocol [@moe2011Fieldassessment] (Table \@ref(tab:tab-culvert-195943)).  Water temperature was `r fpr::fpr_my_habitat_info(col_pull = 'temperature_c')`$^\circ$C, pH was `r fpr::fpr_my_habitat_info(col_pull = 'p_h')` and conductivity was `r fpr::fpr_my_habitat_info(col_pull = 'conductivity_m_s_cm')`uS/cm. A beaver dam was noted just upstream of the culvert inlet (~1.5m high).
...
Taman Creek was surveyed for `r fpr::fpr_my_priority_info(loc = 'us2', col_pull = 'length_surveyed')`m above where it joins the Bulkley River mainstem upstream of PSCIS crossing `r as.character(my_site)`  `r if(gitbook_on){knitr::asis_output("(Figures \\@ref(fig:photo-195943-05) - \\@ref(fig:photo-195943-06))")}else(knitr::asis_output("(Figure \\@ref(fig:photo-195943-d03))"))`. 
