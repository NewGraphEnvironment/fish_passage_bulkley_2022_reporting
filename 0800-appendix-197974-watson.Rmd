...
`r fpr_my_survey_dist(loc = 'us')` `r if(gitbook_on){knitr::asis_output("(Figures \\@ref(fig:photo-197974-03) - \\@ref(fig:photo-197974-04)).")}else(knitr::asis_output("(Figure \\@ref(fig:photo-197974-d02))."))`
...
proceeding to design for replacement.  As the culvert under the highway can be considered a complete barrier to all species and life stages of fish at all flows, it would be necessary to replace it for anadromous fish to populate the watershed upstream of the highway.  For this reason, the highway crossing should be replaced first, before pursueing remedial works at the crossing upstream on Montgomery Road. 
