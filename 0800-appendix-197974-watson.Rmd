...
accommodate pasture with notably less cover and a channel confined by
...
`r fpr_my_habitat_paragraph(loc = 'us')` Abundant gravels present for
spawning. Lower 150-200m of stream is heavily impacted by cattle from
Buckrow Angus farm. Beaver activity is present in lower section. There
are numerous fry throughout. Some deep pools to 0.7m available for
rearing and overwintering for rainbow fry and juvenile. Cattle are
accessing the stream intermittently to the top of site.The habitat was
