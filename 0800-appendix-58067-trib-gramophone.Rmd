...
a maximum of `r fpr::fpr_my_wshd(col = 'elev_max')`m to 375m near the
crossing (Table \@ref(tab:tab-wshd-58067)). Upstream of crossing
...
summary of habitat modelling outputs is presented in Table
...
`r fpr_my_habitat_paragraph(loc = 'ds')` There are abundant undercut
banks available for cover. Some patches present with gravels suitable
for RB/ST and CO spawning. Occasional deep pools present suitable for
rearing and overwintering. The riparian vegetation is an old growth
mixed forest. The habitat was rated as
...
`r if(gitbook_on){knitr::asis_output("(Figures \\@ref(fig:photo-58067-03) - \\@ref(fig:photo-58067-04)).")}else(knitr::asis_output("(Figure \\@ref(fig:photo-58067-d02))."))`
...
a bridge may be considered as a prudent step to eliminating an outlet
drop, reducing flow velocities at the highway crossing.
...
```{r plot-fish-box-58067, fig.cap= my_caption, eval=F}
