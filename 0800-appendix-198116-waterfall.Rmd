...
As the subject tributary to Waterfall Creek was not mapped as present at the location of these crossings, at the time of reporting, there were no crossings modelled as present in `bcfishpass` and so the software generates no fish habitat modelling data. PSCIS crossing `r as.character(my_site2)` is located on `r fpr_my_pscis_info(site = my_site2, col_pull = road_name)`, just downstream of 198116. PSCIS crossing `r as.character(my_site3)` is located on `r fpr_my_pscis_info(site = my_site3, col_pull = road_name)`, upstream of 198116. Crossing `r as.character(my_site)` on Hiighway 16/10th avenue is the responsibility of the Ministry of Transportation and Infrastructure while crossings 198117 and 198115 are the responsibility of the District of New Hazelton.

<br>

```{r fig-waterfall, fig.cap = my_caption}

my_caption = 'Map of Station Creek and Watershed Creek watersheds. Pink line indicates sections of tributary to Waterfall Creek that were sureyed and that at the time of reporting were not mapped correctly in the freshwater atlas.'
...
`r fpr_my_survey_dist(loc = 'ds')` past PSCIS crossing 198177 to adjacent to the CN railway approximately 220m upstream of PSCIS crossing 124423.
