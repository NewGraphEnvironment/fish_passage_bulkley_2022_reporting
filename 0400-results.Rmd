...
```{r photo-dams-01-prep, fig.cap= my_caption1, out.width = photo_width, eval=T}
...
```{r ortho-caption-coffin, fig.cap= my_caption, out.width = "0.01%", eval = F}
...
```{r model-caption-coffin, fig.cap= my_caption, out.width = "0.01%", eval = F}
my_photo = 'fig/pixel.png'
