...
Preliminary climate change risk assessment data for Mnistry of Transportation and Infrastructure sites is presented in Table \@ref(tab:tab-moti-climate).
...
tab_moti %>% 
  ...
  # this waterfall crossing is not an moti site
  select(-`198115`) %>% 
