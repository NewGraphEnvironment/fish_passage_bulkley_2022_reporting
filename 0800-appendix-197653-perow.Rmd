...
(Table \@ref(tab:tab-culvert-197653)). There were large chunks of
concrete just downstream of the outlet that are being used to armour the
channel. There was no water at the time of survey. Water temperature was
...
`r fpr_my_habitat_paragraph(loc = 'ds')` PSCIS crossing 197657 on the highway, approximately 50m
downstream from crossing 197653 was assessed and ranked as passable as it was low gradient, fully embedded and with no outlet drop. It appeared passable to all species and life stages at the time of
assessment (Table \@ref(tab:tab-culvert-197657)). The stream from
...
`r if(gitbook_on){knitr::asis_output("(Figures \\@ref(fig:photo-197653-03) - \\@ref(fig:photo-197653-04)).")}else(knitr::asis_output("(Figure \\@ref(fig:photo-197653-d02))."))` Two sections of stream upstream of the crossing were assessed. As residential buildings and yards were situated immediately adjacent to the stream upstream of the crossing, the stream was accessed in an upstream direction from a ford
...
survey. `r fpr_my_habitat_paragraph(loc = 'us')` Habitat quality improved significantly within the second section of stream surveyed where flows were significant. `r fpr_my_habitat_paragraph(loc = 'us2')` There were gravels present throughout the second site that were noted as suitable for resident and anadromous salmonid spawning.
Infrequent deep pools for salmonids rearing and overwintering were also noted. Overall, the
habitat was rated as `r fpr::fpr_my_priority_info(loc = 'us')` value as
an important migration corridor containing habitat suitable for spawning with moderate rearing potential for juvenile salmonids.
