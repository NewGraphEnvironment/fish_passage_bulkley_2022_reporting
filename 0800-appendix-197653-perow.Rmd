...
\@ref(tab:tab-wshd-197653)). There is no fisheries information upstream of crossing 197653 [@moe2020KnownBC; @norris2020bcfishobs].
...
(Table \@ref(tab:tab-culvert-197653)). There were large chunks of concrete just downstream of the outlet that are being used to armour the channel. There was no
...
located on Highway 16, then an additional 25m downstream from the highway.
...
`r fpr_my_pscis_info(col_pull = road_name)` to the highway was
channelized and completely dewatered at the time of survey. There
...
PSCIS crossing 197657 is located on the highway, approximately 50m downstream from
