...
`r if(gitbook_on){knitr::asis_output("(Figure \\@ref(fig:photo-195944-05)).")}else(knitr::asis_output("(Figure \\@ref(fig:photo-195944-d03))."))` `r fpr_my_habitat_paragraph(loc = 'us', sit = my_site2)` Within the areas surveyed, the stream was noted heavily impacted by cattle activity with significant amounts of manure in the stream, degraded/removed riparian vegetation and extensive areas of trampled banks. There were occasional pockets of gravel suitable for resident rainbow spawning. Field notes indicate, occasional pools with depths suitable for juvenile salmon and adult resident salmonid overwintering. A rock drop of 65cm was located 365m upstream of the top end of the culvert `r if(gitbook_on){knitr::asis_output("(Figure \\@ref(fig:photo-195944-06)).")}else(knitr::asis_output("(Figure \\@ref(fig:photo-195944-d03))."))` This drop would be passable for adult salmonids but dependent on flow conditions it is likely a fish passage issue for the upstream migration of all life stages of resident populations as well as non-adult salmonids.
...
At the time of assessment Stock Creek was heavily impacted by land clearing and cattle throughout the areas surveyed. There is evidence of significant ongoing impacts due to trampled banks and grazed or removed riparian vegetation. It is recommended that a plan be developed to work with adjacent landowners and tenure holders to implement plans to restore the riparian areas and mitigate impacts on stream health. Habitat present was suitable for juvenile coho, steelhead and resident salmonids with fish observed upstream and downstream of crossing `r as.character(my_site)` during field assessments. 
