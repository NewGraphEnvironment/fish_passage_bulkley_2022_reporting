...
River approximately 12km north west of Houston, BC. The site is located on
...
Dogwood Environmental Consulting reports that they are working on a grazing/fuel reduction pilot project in collaboration with BC Wildfire, the Ministry of Agriculture, and BC Cattleman’s Association. Dogwood is working with grazing lease holders and farmers to identify agricultural areas in need of enhancement. Stock Creek is included in one of these target areas, due to its clear signs of cattle use and grazing, leading to significant impacts on stream habitat. Plans to mitigate these impacts and prevent cattle from accessing stream banks are ongoing. The project study area is located upstream of the assessed Highway 16 crossing (pers. comm Jenn Atkins, 2022). 
...
`r fpr_my_habitat_paragraph(loc = 'us')` There was good flow volume and a decent amount of complexity due to boulders and undercut banks. There were small pockets of gravel that may be suitable for resident rainbow and coho spawning. Occasional shallow pools and traces of large water debris were sighted. The channel appeared to be constricted due to agricultural development on both sides of the stream. Water withdrawal is occurring as well. More agricultural development was encroaching on the riparian farther upstream. The
...
`r if(gitbook_on){knitr::asis_output("(Figures \\@ref(fig:photo-195943-03) - \\@ref(fig:photo-195943-04)).")}else(knitr::asis_output("(Figure \\@ref(fig:photo-195943-d02))."))`  
`r fpr_my_habitat_paragraph(loc = 'us')` There were many undercut banks throughout, with fish up tp 20cm long sighted throughout covered areas. There was a cattle trail next to length of creek, with some areas having obvious signs of embankment issues and an associated risk of sediment falling into stream. There were not many gravel patches suitable for spawning. The
...
`r if(gitbook_on){knitr::asis_output("(Figures \\@ref(fig:photo-195944-05) - \\@ref(fig:photo-195944-06)).")}else(knitr::asis_output("(Figure \\@ref(fig:photo-195944-d02))."))` `r fpr_my_habitat_paragraph(loc = 'us', sit = my_site2)` This section of the stream is likely an important migration corridor, however the stream is heavily impacted by cattle activity. There were significant amounts of cattle manure in the stream, which resulted in water quality levels above thresholds. There were occasional pockets of gravel suitable for resident rainbow spawning. Boulders were the significant cover however there were occasional pools with depths suitable for overwintering. Decent amount of rearing habitat for juveniles though. There was a small rock drop of 65cm located 365m upstream of the top end of the culvert. 
