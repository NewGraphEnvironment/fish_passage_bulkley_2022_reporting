...
would be suitable for rainbow, steelhead and coho spawning. Occasional deep pools were
present that would serve as good habitat suitable for fish rearing and
overwintering. The riparian vegetation was an old growth mixed forest.
The habitat was rated as `r fpr::fpr_my_priority_info(loc = 'ds')` value
