...
spawning. In 2023 the site was revisited and crews walked from the crossing down to the Bulkley River. Crews observed a canyon with two falls at ~1.7m and a 25m rock chute approximately 500m upstream from the confluence with the Bulkley River (Figures \@ref(fig:canyon) - \@ref(fig:chute) - \@ref(fig:falls)). At the time of assessment, the bottom few hundred meters of stream were de-watered. 
...
In 2023 fish sampling was conducted below the observed falls using dip nets. Six Coho were caught, 2 fry (FL ranging from 65-67mm), and 4 par (FL ranging from 70-90mm), see photos \@ref(fig:fish). Since Coho were captured below the falls but none at crossing `r as.character(my_site)` (during the 2022 sampling), it is presumed that the falls are a barrier to Coho passage. 


```{r fish, fig.cap = "Coho fry and par captured below the falls with dip nets during 2023 sampling."}
